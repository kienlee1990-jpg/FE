...
export const DANH_GIA_TRACKED_STATUS_OPTIONS = DANH_GIA_STATUS_OPTIONS.filter(
  item => item.value === 'HOAN_THANH_VUOT_MUC' ||
...
export function getDanhGiaStatusCode(value) {
  ...
  return STATUS_ALIASES[normalized] || STATUS_LABEL_ALIASES[normalized] || normalized || ''
}
